...
public class NotificationController {
	...
	@PutMapping("/read/{id}")
	public ResponseEntity<ReponseDTO> readNotification(@PathVariable Long id) throws JobPortalException{
		notificationService.readNotification(id);
		return new ResponseEntity<>(new ReponseDTO("Success"), HttpStatus.OK);
	}
}
